...
<body>
	...
	<body
	style="background-image: url(img/macaroons.jpg); background-repeat: repeat-y;">
	<link
		href="https://fonts.googleapis.com/css?family=Roboto:400,300,400italic"
		rel="stylesheet" type="text/css">
	<link rel="stylesheet"
		href="javascripts/stylesheets/jquery.sidr.dark.css">
				...
				<div class="inner cover">
					...
					<div class="jumbotron">
						...
						<form action="createlistPHP.php" method="post">
							<table align="center">
								<tr>
									<td style="color: black">Name your list:</td>
									<td><input type="text" name="listname" style="color: black"></td>
								</tr>
								<br />
								<tr>
									<td colspan="2"><input type="text" name="item_1"
										style="color: black"></td>
								</tr>
								<br />

								<tr>
									<td colspan="2"><input type="text" name="item_2"
										style="color: black"></td>
								</tr>
								<br />

								<tr>
									<td colspan="2"><input type="text" name="item_3"
										style="color: black"></td>
								</tr>
								<br />
								<tr>
									<td colspan="2"><input type="text" name="item_4"
										style="color: black"></td>
								</tr>
								<br />
								<tr>
									<td colspan="2"><input type="text" name="item_5"
										style="color: black"></td>
								</tr>
								<br />
								<tr>
									<td><button class="btn btn-success btn-block " type="submit">Go
											Shopping</button></td>
									<td><button class="btn btn-success btn-block " type="submit">Save
											List</button></td>
								</tr>
							</table>
						</form>
